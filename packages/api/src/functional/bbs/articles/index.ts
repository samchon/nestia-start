...
import type { IBbsArticle, IPage } from "@ORGANIZATION/PROJECT-api";
...
export namespace at {
  ...
  export const path = (props: Props) =>
    `/bbs/articles/${encodeURIComponent(
      props.section?.toString() ?? "null",
    )}/${encodeURIComponent(props.id?.toString() ?? "null")}`;
